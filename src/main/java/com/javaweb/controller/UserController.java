...
public class UserController {
    ...
    public String updateProfile(
        ...
        try {
            UserResponse userResponse = usersService.updateInfor(userRequest);
    ...
    public String updateAvatar(
        ...
        try {
            ...
            usersService.updateAvatar(id, username, avatarFile);
    ...
    public ResponseEntity<?> getUserId(@RequestParam String username) {
        try {
            UserResponse taiKhoan = usersService.findByUsername(username);
            if (taiKhoan != null) {
                return ResponseEntity.ok(Map.of("userId", taiKhoan.getId()));
            }
            return ResponseEntity.notFound().build();
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Map.of("message", "Không thể lấy userId: " + e.getMessage()));
        }
    }
